...
export default class RequestApproval extends React.Component<IRequestApprovalProps, {}> {
  public render(): React.ReactElement<IRequestApprovalProps> {
    ...
    return (
      <section className={`${styles.requestApproval} ${hasTeamsContext ? styles.teams : ''}`}>
